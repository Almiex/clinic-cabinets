...
# ==================== НОРМАЛИЗАЦИЯ ====================
SPEC_MAP = {
    # --- Точные сложные совпадения с нового скриншота (со скобками и без) ---
    'онколог, онколог-маммолог, хирург(кво)': 'Онкология',
    'аллерголог-иммунолог, пульмонолог (кво)': 'Аллергология-иммунология',
    'акушер-гинеколог, эндокринолог (кво)': 'Гинекология',
    'акушер-гинеколог, узд (кво)': 'Гинекология',
    'психиатр, психотерапевт (кво)': 'Психиатрия',
    'гастроэнтеролог, терапевт (кво)': 'Гастроэнтерология',
    'отоларинголог, терапевт (кво)': 'ЛОР',
    'колопроктолог, хирург (кво)': 'Колопроктология',
    'травматолог-ортопед, хирург(кво)': 'Травматология',
    'кардиолог-невролог(кво)': 'Кардиология',
    'врач ультразвуковой диагностики (кво)': 'УЗИ',
    'врач функциональной диагностики (кво)': 'Функц. диагностика',
    
    # --- Одиночные со скобками (кво) для железного перехвата на шаге №1 ---
    'кардиолог (кво)': 'Кардиология',
    'невролог (кво)': 'Неврология',
    'мануальный терапевт (кво)': 'Мануальная терапия',
    'психолог (кво)': 'Психология',
    'терапевт (кво)': 'Терапия',
    'гастроэнтеролог(кво)': 'Гастроэнтерология',
    'психиатр(кво)': 'Психиатрия',
    'акушер-гинеколог (кво)': 'Гинекология',
    'аллерголог-иммунолог (кво)': 'Аллергология-иммунология',
    'отоларинголог (кво)': 'ЛОР',
    'рентгенолог (кво)': 'Рентген',
    'кабинет (кво)': 'Процедурные',
    'травматолог-ортопед (кво)': 'Травматология',
    'эндокринолог (кво)': 'Эндокринология',
    'хирург (кво)': 'Хирургия',
    'сосудистый хирург (кво)': 'Хирургия',
    'дерматовенеролог (кво)': 'Дерматология',
    'дерматолог(кво)': 'Дерматология',
    'пульмонолог-фтизиатр (кво)': 'Пульмонология',
    'уролог (кво)': 'Урология',
    'флеболог(кво)': 'Флебология',

    # --- Двойные и сложные базовые специальности (без скобок) ---
    'онколог, онколог-маммолог, хирург': 'Онкология',
    'аллерголог-иммунолог, пульмонолог': 'Аллергология-иммунология',
