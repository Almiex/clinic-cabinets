...
# ==================== НОРМАЛИЗАЦИЯ ====================
SPEC_MAP = {
    # --- Двойные и сложные специальности (Самый высокий приоритет) ---
    ...
    # --- Одиночные терапевтические и общие направления ---
    'терапевт': 'Терапия',
    ...
    # --- Одиночные хирургические и ортопедические направления ---
    'хирургия': 'Хирургия',
    'хирург': 'Хирургия',
    ...
    # --- Кабинеты, лаборатория и службы клиники ---
